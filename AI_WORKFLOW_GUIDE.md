...
> DO:
>
> 1. Create root package.json with workspaces: ["packages/_", "apps/_"]
...
3.  If there's an error, copy the error message and feed it back to the agent: _"I got this error when running `npm run dev`: [error message]. Please fix it."_
